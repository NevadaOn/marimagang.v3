        ...
        <div class="row">
              ...
              <div class="form-login bg-gray-850 border-gray-800 text-start">
                <form method="POST" action="{{ url('/login') }}">
                  ...
                  <div class="form-group">
                    <input class="form-control bg-gray-850 border-gray-800" type="email" name="email" id="email"
          ...
          @enderror
                  ...
                  <div class="form-group position-relative">
                    <input class="form-control bg-gray-850 border-gray-800 password" type="password" name="password"
          ...
          <div class="mt-4">
            <div
            class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative text-center animate-fade-in-down"
            role="alert">
