...
<div class="container py-5">
    <div class="card shadow-sm p-4 mb-4">
        ...
        <form id="form-pengajuan" action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateTanggal();">
            @csrf
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <small class="text-muted">Tanggal mulai minimal hari ini.</small>
                </div>
                <div class="col-md-6">
            ...
            <div id="tanggal-error" class="alert alert-warning d-none"></div>
                ...
                <div class="card p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label>Nama</label>
                            <input type="text" id="input-nama" class="form-control" placeholder="Nama Anggota">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>NIM</label>
                            <input type="text" id="input-nim" class="form-control" placeholder="NIM Anggota">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Email</label>
                            <input type="email" id="input-email" class="form-control" placeholder="Email Anggota">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>No HP</label>
                            <input type="text" id="input-nohp" class="form-control" placeholder="No HP Anggota">
                        </div>
                        <div class="col-12 mb-2">
                            <label>Skill</label>
                            <input type="text" id="input-skill" class="form-control" placeholder="Skill Anggota">
                        </div>
            ...
            <div class="mb-3">
                <label class="form-label">Surat Pengantar Magang (PDF, maks 2MB)</label>
                <input type="file" name="dokumen[surat_pengantar]" class="form-control" accept="application/pdf" required>
            </div>
            <div class="mb-4">
                <label class="form-label">Proposal (PDF, maks 2MB)</label>
                <input type="file" name="dokumen[proposal]" class="form-control" accept="application/pdf" required>
            </div>
...
function validateTanggal() {
    ...
    if (tglMulai < today) {
        errorDiv.innerHTML = 'Tanggal mulai minimal hari ini.';
        errorDiv.classList.remove('d-none');
        return false;
    }
    if (tglSelesai <= tglMulai) {
        errorDiv.innerHTML = 'Tanggal selesai harus setelah tanggal mulai.';
        errorDiv.classList.remove('d-none');
        return false;
    }
    return true;
