...
<head>
    ...
    <link rel="shortcut icon" href="./bidang/compiled/svg/favicon.svg" type="image/x-icon">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="./bidang/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
                        </div>
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                <h6 class="text-muted font-semibold">Total Semua Pengajuan</h6>
                                            ...
                                            <div class="col-7">
                                                <div class="d-flex align-items-center">
                                                    <svg class="bi text-primary" width="32" height="32" fill="blue"
                                                        style="width:10px">
                                                        <use
                                                            xlink:href="bidang/static/images/bootstrap-icons.svg#circle-fill" />
                                                    </svg>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="./bidang/compiled/jpg/5.jpg">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="./bidang/compiled/jpg/2.jpg">
                                                                </div>
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="./bidang/compiled/jpg/1.jpg" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="./bidang/compiled/jpg/4.jpg">
                                    </div>
                                    <div class="name ms-4">
                                ...
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="./bidang/compiled/jpg/1.jpg">
                                    </div>
                                    <div class="name ms-4">
