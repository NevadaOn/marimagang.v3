    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ Request::routeIs('admin.pengajuan.index') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.pengajuan.index') }}">
            ...
            <li class="sidebar-item {{ Request::routeIs('admin.universitas.index') ? 'active' : '' }}"> {{-- Asumsi ada rute untuk daftar universitas --}}
                <a class="sidebar-link" href="{{ route('admin.pengajuan.index') }}"> {{-- Sesuaikan rute jika daftar universitas beda dari pengajuan --}}
                    <i class="align-middle" data-feather="square"></i> <span class="align-middle">Daftar Universitas</span>
                </a>
            </li>
