<nav
  class="bg-white/10 backdrop-blur-md shadow-sm border-b border-white/10 px-4 py-3 rounded-xl flex items-center justify-between relative z-50">
  <!-- Sidebar Toggle -->
  ...
  <div class="flex items-center gap-6">
    ...
    <div class="relative">
      <button onclick="toggleDropdown('notifDropdown')" class="text-white relative text-lg">
        ...
        <span
          class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">4</span>
      </button>
      <div id="notifDropdown"
        class="absolute right-0 mt-2 w-80 bg-black/70 backdrop-blur-2xl text-white rounded-lg shadow-lg hidden z-40">
    ...
    <div class="relative">
      ...
      <div id="pesanDropdown"
        class="absolute right-0 mt-2 w-80 bg-black/70 backdrop-blur-md text-white rounded-lg shadow-lg hidden z-40">
    ...
    <div class="relative">
      ...
      <div id="profileDropdown"
        class="absolute right-0 mt-2 w-56 bg-black/70 backdrop-blur-md text-white rounded-lg shadow-lg hidden z-40">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
          class="block px-4 py-2 text-red-400 hover:bg-white/5">
